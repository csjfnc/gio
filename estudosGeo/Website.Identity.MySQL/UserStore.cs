...
namespace Website.Identity.MySQL
{
        ...
        where TUserClaim : IdentityUserClaim<TKey>, new()
    {
        ...
        public virtual async Task<TUser> FindAsync(UserLoginInfo login)
        {
            ...
            var userLogin = await _logins.FirstOrDefaultAsync(l => l.LoginProvider == provider && l.ProviderKey == key).WithCurrentCulture();
            if (userLogin != null)
            {
        ...
        /// <summary>
        /// ** Custom - Find a user by login
        /// </summary>
        /// <param name="userLogin"></param>
        /// <returns></returns>
        public virtual Task<TUser> FindByNameAsync(string userLogin)
        {
            ThrowIfDisposed();
            return GetUserAggregateAsync(u => u.UserLogin.ToUpper() == userLogin.ToUpper());
        }
